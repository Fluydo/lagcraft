      ...
      <header className="bg-card border-b border-primary/20 p-4 sticky top-0 z-50 backdrop-blur-sm bg-opacity-80">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <h1 className="font-heading font-bold text-2xl md:text-3xl bg-gradient-to-r from-[hsl(var(--accent-purple-light))] via-[hsl(var(--accent-purple))] to-[hsl(var(--accent-purple-dark))] bg-clip-text text-transparent">
              LagCraft
            </h1>
            <div className="ml-6 font-tech text-[hsl(var(--accent-purple))] flex items-center border border-[hsl(var(--accent-purple))]/30 px-3 py-1 rounded">
